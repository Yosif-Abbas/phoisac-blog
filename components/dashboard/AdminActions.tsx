...
export default function AdminActions() {
  ...
  if (!user || !isAdmin || !isPostPage) return null;

  return (
    <div className="lg:sticky lg:top-24 col-start-1 row-start-1 lg:row-start-1 lg:col-start-3 lg:flex items-start h-fit">
