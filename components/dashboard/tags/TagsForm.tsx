...
export default function TagsForm() {
  ...
  return (
    <section className="bg-white/5 border border-card-hover p-6 rounded-2xl flex flex-col gap-y-4">
      ...
      <form onSubmit={handleAdd} className="flex gap-x-4">
        <div className="flex-1 relative">
          <input
            ...
            className="w-full bg-background border border-card-hover rounded-xl px-4 py-3 focus:ring-1 focus:ring-[#1F2937] outline-none transition-all"
          />
