              ...
              if (isClassic && line.ajuuz) {
                return `
                  <tr>
                    ...
                    <td align="left" width="45%" valign="top" style="font-family: serif; font-size: 1.3em; color: #4b5563; padding-bottom: 15px;">${clean(line.ajuuz || "")}</td>
                  </tr>`;
              }
              return `
                <tr>
                ...
                <tr>
                  <td colspan="3" align="center" style="padding-top: 20px;">
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="20" style="border-bottom: 1px solid #cbd5e1;">&nbsp;</td>
